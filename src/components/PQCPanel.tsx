  ...
  return (
    <section aria-labelledby="pqc-panel-heading" className="flex flex-col gap-4 h-full">
      ...
      <section className="rounded-lg bg-[#0d0d18] border border-[#1e1e30] p-4" aria-labelledby="lattice-hard-heading">
        <h3 id="lattice-hard-heading" className="text-xs text-gray-500 font-mono mb-3">WHY QUANTUM CAN&apos;T BREAK LATTICE</h3>

        <div className="space-y-3">
          <article className="flex items-start gap-3">
            <div className="w-8 h-8 rounded bg-[#a855f7]/10 flex items-center justify-center shrink-0" aria-hidden="true">
              <span className="text-[#a855f7] text-sm">√</span>
            </div>
            <div>
              <h4 className="text-sm text-white">Grover&apos;s Algorithm: Only √n speedup</h4>
          ...
          <article className="flex items-start gap-3">
            <div className="w-8 h-8 rounded bg-[#4d9fff]/10 flex items-center justify-center shrink-0" aria-hidden="true">
              <span className="text-[#4d9fff] text-sm">∞</span>
            </div>
            <div>
              <h4 className="text-sm text-white">No known quantum algorithm for{" "}
          ...
          <article className="flex items-start gap-3">
            <div className="w-8 h-8 rounded bg-[#fbbf24]/10 flex items-center justify-center shrink-0" aria-hidden="true">
              <span className="text-[#fbbf24] text-sm">⊕</span>
            </div>
            <div>
              <h4 className="text-sm text-white">Noise hides the secret</h4>
              <p className="text-xs text-gray-500 mt-0.5">
      ...
      <section className="rounded-lg bg-[#0d0d18] border border-[#1e1e30] p-4" aria-labelledby="grover-comparison-heading">
        <h3 id="grover-comparison-heading" className="text-xs text-gray-500 font-mono mb-3">
      ...
      <section className="rounded-lg bg-[#0d0d18] border border-[#1e1e30] p-4" aria-labelledby="mlkem-levels-heading">
        <h3 id="mlkem-levels-heading" className="text-xs text-gray-500 font-mono mb-3">ML-KEM SECURITY LEVELS</h3>
        <ul className="space-y-2" role="list">
          {pqcAlgorithms.map((algo) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <span className="text-[10px] text-gray-500 cursor-help" title={algo.nistRef}>
